...
- Created an interactive **3-page Power BI dashboard** featuring 12+ business visuals to analyze revenue, transaction trends, merchant performance, customer behavior, and fraud patterns.
